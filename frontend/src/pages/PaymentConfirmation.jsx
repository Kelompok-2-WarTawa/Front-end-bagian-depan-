                ...
                <div style={styles.summaryBoxOuter}>
                    ...
                    {ticketData.selectedSeats.length > 0 && (
                        <div style={styles.summaryRow}>
                            ...
                            <span>{ticketData.selectedSeats.length} x @ {formatRupiah(ticketData.pricePerSeat)}</span>
                        </div>
                    )}

                    <div style={{ ...styles.summaryRow, fontSize: '13px', color: '#555', marginBottom: '15px' }}>
                        <span>Kursi:</span>
                        <span style={{ textAlign: 'right', maxWidth: '150px' }}>{ticketData.selectedSeats.map(s => s.label).join(', ')}</span>
                    </div>

                    <hr style={{ border: 'none', borderTop: '1px solid #ccc', margin: '15px 0' }} />

                    <div style={styles.summaryRow}><span>TOTAL</span><span>{formatRupiah(ticketData.selectedSeats.length * ticketData.pricePerSeat)}</span></div>
