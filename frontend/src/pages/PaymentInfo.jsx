            ...
            <div className="container" style={{ padding: '40px 20px', maxWidth: '800px', margin: '0 auto' }}>
                ...
                <div style={styles.mainCard}>
                    ...
                    <div style={styles.formContainer}>
                        ...
                        <div style={styles.inputGroup}><label style={styles.label}>ID Number (NIK)</label><input type="text" name="idNumber" style={styles.input} value={formData.idNumber} onChange={handleChange} placeholder="NIK / SIM" /></div>
