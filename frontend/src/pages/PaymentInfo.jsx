...
const PaymentInfo = () => {
  ...
  // --- 1. AMBIL DATA DARI HALAMAN SEBELUMNYA (FIX) ---
  // Kita bongkar data yang dikirim dari PaymentSelect. 
  // Jika tidak ada data (akses langsung url), beri nilai default 0.
  const { qtyReguler = 0, qtyVVIP = 0, totalHarga = 0 } = location.state || {};
  ...
  const handleNext = () => {
    ...
    // Kirim SEMUA data (Tiket + Data Diri) ke halaman Konfirmasi
    navigate('/payment/confirmation', {
      state: {
        qtyReguler, // Data Tiket
        qtyVVIP,    // Data Tiket
        totalHarga, // Data Tiket
        ...formData // Data Diri (fullName, email, dll)
      }
    });
  };
      ...
      <div className="container" style={{ padding: '40px 20px' }}>
        ...
        <div style={styles.stepBar}>
          <div style={styles.stepItem}>
            <span style={styles.stepCircleDone}>✓</span> Select Category
          </div>
        ...
        <div style={styles.mainCard}>
          ...
          <div style={styles.buttonRow}>
            <button onClick={() => navigate('/payment/select')} style={styles.btnBack}>
                Back
            </button>
        ...
        <div style={styles.summaryBoxOuter}>
             ...
             {/* Hanya muncul jika Reguler dipilih */}
             {qtyReguler > 0 && (
               <div style={styles.summaryRow}>
                  <span>Reguler</span>
             ...
             <div style={styles.summaryRow}>
                <span>TOTAL</span>
                {/* Menggunakan format Rupiah asli dari data */}
...
const styles = {
  ...
  stepCircleActive: {
    width: '28px', height: '28px', backgroundColor: 'black', color: '#F59E0B',
    borderRadius: '50%', display: 'flex', justifyContent: 'center', alignItems: 'center', fontWeight: 'bold'
  },
  stepCircleDone: {
    width: '28px', height: '28px', backgroundColor: 'black', color: '#F59E0B',
    borderRadius: '50%', display: 'flex', justifyContent: 'center', alignItems: 'center', fontWeight: 'bold'
  ...
  stepCircle: {
    width: '26px', height: '26px', border: '2px solid #553C00',
    borderRadius: '50%', display: 'flex', justifyContent: 'center', alignItems: 'center', fontWeight: 'bold'
  },
  mainCard: {
  ...
  formContainer: {
    backgroundColor: '#FFFBEB', borderRadius: '12px', padding: '30px',
    marginBottom: '20px'
  },
  ...
  input: {
    ...
    backgroundColor: '#1F2937', color: 'white', fontSize: '16px'
  },
